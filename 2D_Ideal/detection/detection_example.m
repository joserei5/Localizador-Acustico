...
hidefig = 0;
[yL, yR] = sim_stereo(rstruct, roomsize, recloc, dir, spkloc, y, fs, hidefig);
...
for i=1:N
    [yL, yR] = sim_stereo(rstruct, roomsize, recloc, [theta_range(i), 0], spkloc, y, fs, 1);
