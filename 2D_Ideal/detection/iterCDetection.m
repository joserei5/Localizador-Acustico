function [] = iterCDetection(room, rec, distance, points)
    ...
    M_lbl = uicontrol(  'Parent',f,...
                        'Style','text',...
                        'Position',[0,70,150,23],...
                        'String',join(['Predicted = ', num2str(round(azimuth)), "º"]),...
                        'BackgroundColor',f.Color);

    M_lbl2 = uicontrol( 'Parent',f,...
                        'Style','text',...
                        'Position',[0,50,150,23],...
                        'String',join(['Theoretical = ', num2str(round(th_azimuth(1))), "º"]),...
                        'BackgroundColor',f.Color);

    M_lbl3 = uicontrol( 'Parent',f,...
                        'Style','text',...
                        'Position',[0,30,140,23],...
                        'String',join(['Error = ', num2str(round(e_azimuth)), "º"]),...
                        'BackgroundColor',f.Color);
...
%         angle = 90 - acosd((rp(bIndex,1) - ox)/distance);
        set(M_lbl,'String', join(['Predicted = ', num2str(round(azimuth)), "º"]));
        set(M_lbl2,'String', join(['Theoretical = ', num2str(round(th_azimuth(bIndex))), "º"]));
        set(M_lbl3,'String', join(['Error = ', num2str(round(e_azimuth)), "º"]));
        hold off
        view(2)
    end
