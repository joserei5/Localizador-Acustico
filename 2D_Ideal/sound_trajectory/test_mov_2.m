...
AW = addWall([], [ 0  0  0], [20  0 0], [20 20 0], [ 0 20 0], 0.5); % chão
...
%%%%%%% Sinal da fonte %%%%%%%%%%%%%%%%
% O número de amostras de s tem de ser superior a N + a duração da resposta
% impulsional
...
y = zeros(2,N); % 2 microfones e o sinal da saída terá o mesmo número de pontos que a trajectória

S = addSpk( [p_x(1) 1 1]); % posição inicial da fonte
...
for n=1:N
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%% alterado %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    if n+M-1>N % caso n seja necessário amostras fora do sinal y (assume-se que serão zero) e removem-se da resposta impulsional
        M = N+1-n;
        I(:,M+1:end) = [];
    end
